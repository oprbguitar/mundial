...
export const copy = {
  es: {
    ...
    follow:'Sigue en tiempo real todos los partidos.', more:'Actualizaciones, estadísticas y más.', vs:'vs',
  },
  en: {
    ...
    follow:'Follow all matches in real time.', more:'Updates, statistics and more.', vs:'vs',
  },
