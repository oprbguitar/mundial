...
export const copy = {
  es: {
    title:'Partidos 2026', subtitleFirst:'Primera fecha de fase de grupos', subtitleSecond:'Segunda fecha de fase de grupos', subtitleThird:'Tercera fecha de fase de grupos', subtitleKnockout:'Fase de eliminación directa', viewTime:'Horario', language:'Idioma',
    all:'Todas', mexico:'México', usa:'EE.UU.', canada:'Canadá', scheduled:'Programado', live:'En juego', finished:'Finalizado',
    group:'Grupo', dates:'Fechas:', first:'Primera fecha', second:'Segunda fecha', third:'Tercera fecha', knockout:'Eliminatorias', round32:'Eliminatoria de 32', round16:'Octavos', quarterfinals:'Cuartos', semifinals:'Semifinales', thirdPlace:'Tercer puesto', final:'Final',
    timePrefix:'Todos los horarios están en', localTime:'Hora Perú', notice:'Los horarios pueden cambiar. Consulta la información más reciente.',
  ...
  en: {
    ...
    timePrefix:'All times are shown in', localTime:'Peru time', notice:'Times may change. Check the latest information.',
