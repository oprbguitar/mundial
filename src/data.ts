...
export const matches: Match[] = [
  ...
  m('f1','F',14,'15:00','Netherlands','🇳🇱','Japan','🇯🇵','USA','AT&T Stadium','Arlington','2-2'),
  m('f2','F',14,'21:00','Sweden','🇸🇪','Tunisia','🇹🇳','USA','AT&T Stadium','Arlington','5-1'),
  m('g1','G',15,'14:00','Belgium','🇧🇪','Egypt','🇪🇬','USA','Mercedes-Benz Stadium','Atlanta','1-1'),
  m('g2','G',15,'20:00','Iran','🇮🇷','NewZealand','🇳🇿','USA','Mercedes-Benz Stadium','Atlanta','2-2'),
  m('h1','H',15,'11:00','Spain','🇪🇸','CapeVerde','🇨🇻','USA','NRG Stadium','Houston','0-0'),
  m('h2','H',15,'17:00','SaudiArabia','🇸🇦','Uruguay','🇺🇾','USA','NRG Stadium','Houston','1-1'),
  m('i1','I',16,'14:00','France','🇫🇷','Senegal','🇸🇳','USA','SoFi Stadium','Inglewood','3-1'),
  m('i2','I',16,'17:00','Iraq','🇮🇶','Norway','🇳🇴','USA','SoFi Stadium','Inglewood','1-4'),
  m('j1','J',16,'20:00','Argentina','🇦🇷','Algeria','🇩🇿','USA','Levi’s Stadium','Santa Clara','3-0'),
  m('j2','J',16,'23:00','Austria','🇦🇹','Jordan','🇯🇴','USA','Levi’s Stadium','Santa Clara','3-1'),
  m('k1','K',17,'12:00','Portugal','🇵🇹','DRCCongo','🇨🇩','USA','Lincoln Financial Field','Filadelfia','1-1'),
  m('k2','K',17,'21:00','Uzbekistan','🇺🇿','Colombia','🇨🇴','USA','Lincoln Financial Field','Filadelfia','1-3'),
  m('l1','L',17,'15:00','England','🏴','Croatia','🇭🇷','USA','Gillette Stadium','Foxborough','4-2'),
  m('l2','L',17,'18:00','Ghana','🇬🇭','Panama','🇵🇦','USA','Gillette Stadium','Foxborough','1-0'),
]

const fixture = (id: string, group: string, dateTime: string, home: string, away: string, city: string, score?: string|null): Match => ({
  id, group, dateTime, home, away, homeFlag:'', awayFlag:'', host:'USA', stadium:'', city, score: score ?? null, status: score ? 'finished' : 'scheduled',
})

export const secondMatchday: Match[] = [
  fixture('s1','A','2026-06-18T12:00:00-04:00','Czechia','SouthAfrica','Atlanta','1-1'),
  fixture('s2','A','2026-06-18T19:00:00-06:00','Mexico','SouthKorea','Guadalajara (Zapopan)','1-0'),
  fixture('s3','B','2026-06-18T12:00:00-07:00','Switzerland','Bosnia','Los Angeles (Inglewood)','4-1'),
  fixture('s4','B','2026-06-18T15:00:00-07:00','Canada','Qatar','Vancouver','6-0'),
  fixture('s5','C','2026-06-19T18:00:00-04:00','Scotland','Morocco','Boston (Foxborough)','0-1'),
  fixture('s6','C','2026-06-19T20:30:00-04:00','Brazil','Haiti','Philadelphia','3-0'),
  fixture('s7','D','2026-06-19T12:00:00-07:00','USA','Australia','Seattle','2-0'),
  fixture('s8','D','2026-06-19T20:00:00-07:00','Turkey','Paraguay','San Francisco Bay Area (Santa Clara)','0-1'),
  fixture('s9','E','2026-06-20T16:00:00-04:00','Germany','IvoryCoast','Toronto','2-1'),
  fixture('s10','E','2026-06-20T19:00:00-05:00','Ecuador','Curacao','Kansas City','0-0'),
  fixture('s11','F','2026-06-20T12:00:00-05:00','Netherlands','Sweden','Houston','5-1'),
  fixture('s12','F','2026-06-20T22:00:00-06:00','Tunisia','Japan','Monterrey (Guadalupe)','0-4'),
  fixture('s13','G','2026-06-21T12:00:00-07:00','Belgium','Iran','Los Angeles (Inglewood)','0-0'),
  fixture('s14','G','2026-06-21T18:00:00-07:00','NewZealand','Egypt','Vancouver','1-3'),
  fixture('s15','H','2026-06-21T12:00:00-04:00','Spain','SaudiArabia','Atlanta','4-0'),
  fixture('s16','H','2026-06-21T18:00:00-04:00','Uruguay','CapeVerde','Miami (Miami Gardens)','2-2'),
  fixture('s17','I','2026-06-22T17:00:00-04:00','France','Iraq','Philadelphia','3-0'),
  fixture('s18','I','2026-06-22T20:00:00-04:00','Norway','Senegal','New York/New Jersey (East Rutherford)','3-2'),
  fixture('s19','J','2026-06-22T12:00:00-05:00','Argentina','Austria','Dallas (Arlington)','2-0'),
  fixture('s20','J','2026-06-22T20:00:00-07:00','Jordan','Algeria','San Francisco Bay Area (Santa Clara)','1-2'),
  fixture('s21','K','2026-06-23T12:00:00-05:00','Portugal','Uzbekistan','Houston','5-0'),
  fixture('s22','K','2026-06-23T20:00:00-06:00','Colombia','DRCCongo','Guadalajara (Zapopan)','1-0'),
  fixture('s23','L','2026-06-23T16:00:00-04:00','England','Ghana','Boston (Foxborough)','0-0'),
  fixture('s24','L','2026-06-23T19:00:00-04:00','Panama','Croatia','Toronto','0-1'),
]
...
export const thirdMatchday: Match[] = [
  ...
  fixture('t13','G','2026-06-26T20:00:00-07:00','Egypt','Iran','Seattle','1-1'),
  fixture('t14','G','2026-06-26T20:00:00-07:00','NewZealand','Belgium','Vancouver','1-5'),
  fixture('t15','H','2026-06-26T19:00:00-05:00','CapeVerde','SaudiArabia','Houston','0-0'),
  fixture('t16','H','2026-06-26T18:00:00-06:00','Uruguay','Spain','Guadalajara (Zapopan)','0-1'),
  ...
  fixture('t19','J','2026-06-27T21:00:00-05:00','Algeria','Austria','Kansas City','3-3'),
  fixture('t20','J','2026-06-27T21:00:00-05:00','Jordan','Argentina','Dallas (Arlington)','1-3'),
  fixture('t21','K','2026-06-27T19:30:00-04:00','Colombia','Portugal','Miami (Miami Gardens)','0-0'),
  fixture('t22','K','2026-06-27T19:30:00-04:00','DRCCongo','Uzbekistan','Atlanta','3-1'),
  fixture('t23','L','2026-06-27T17:00:00-04:00','Panama','England','New York/New Jersey (East Rutherford)','0-2'),
  fixture('t24','L','2026-06-27T17:00:00-04:00','Croatia','Ghana','Philadelphia','2-1'),
]
